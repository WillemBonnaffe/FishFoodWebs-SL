...
Y_mean    = mean(dataset$max_troph_lvl,na.rm=T)
Y_sd      = sd(dataset$max_troph_lvl,na.rm=T)
...
colnames(X_obs) = c("Intercept","Ecosystem Type","Temperature","Temperature^2","Temperature * Ecosystem Type","BOD","BOD^2","Ecosystem Type * BOD","Temperature * BOD","Temperature * BOD * Ecosystem Type","Species Richness","Year")
