...
X_obs   =                 cbind(1, type,temp,temp^2,temp*type,dbo,dbo^2,type*dbo,temp*dbo,temp*dbo*type,rich,year)
...
n_beta  = ncol(X_obs)
colnames(X_obs) = c("1","type","temp","temp^2","temp*type","dbo","dbo^2","type*dbo","temp*dbo","temp*dbo*type","rich","year")
