...
## 05-07-2022 - added log normal for missing dbo variance
...
{
    X_mis[,7:10] = X_mis[,7:10] * cbind(x_mis,x_mis^2,x_mis,x_mis)
...
X_mis_      = X_mis
X_mis_[,7:10] = X_mis_[,7:10] * cbind(x_mis_,x_mis_^2,x_mis_,x_mis_)
